# ===============================
# Modul: S3
# Zweck: Erstellung eines S3 Buckets mit statischer Website-Hosting-Funktion, Zugriffskontrolle über CloudFront und VPC Endpoint.
# ===============================
...
# Aktivierung von statischem Website-Hosting (optional)
...
resource "aws_s3_bucket_policy" "s3_bucket_policy" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      # Zugriff über VPC Endpoint (z. B. von EC2 aus)
      {
        Effect = "Allow"
        Principal = "*"
